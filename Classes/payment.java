...
public class payment extends JFrame implements ActionListener {
    ...
    //radio button
      ...
      //VISA
       ...
       l5= new JLabel(new ImageIcon(getClass().getResource("/image/visa1.png")));
       l5.setOpaque(true);
      ...
      //MasterCard
       ...
       l6= new JLabel(new ImageIcon(getClass().getResource("/image/maca.png")));
       l6.setOpaque(true);
     ...
     //Paypal
       ...
       l7= new JLabel(new ImageIcon(getClass().getResource("/image/pp1.png")));
       l7.setOpaque(true);
    ...
    //checking  if payment method is selected or not  &&   textfield are filled or not
		...
		else if(ae.getSource()==b2)
		{
            if(!(b3.isSelected() || b4.isSelected() || b5.isSelected()))
            {
                ...
                JOptionPane.showMessageDialog(this,"Enjoy your Tesla!..");
